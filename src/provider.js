...
function AuthProvider(props) {
    ...
    console.log("running Function AuthProvider");
    // Get Auth state
    const getAuthState = async () => {
        console.log("running function getAuthState");    
        try {
            //GET TOKEN && USER
    ...
    const handleLogin = async (data) => {
        console.log("running function handleLogin");
        try{
            //STORE DATA
            let {token, user} = data;
    ...
    const handleLogout = async () => {
        console.log("running function handleLogout");
