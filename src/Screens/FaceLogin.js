    ...
    return (
      <View style={styles.preview}>
        ...
        <TouchableOpacity style={Platform.OS === 'android' ? styles.androidButton : styles.iosButton} onPress={this.switchFacing}>
          <Image style={Platform.OS === 'android' ? styles.androidImg : styles.iosImg} source={require('../assets/images/flipCamera.png')}/>
        </TouchableOpacity>
        <TouchableOpacity style={styles.returnButton} onPress={this.navigation.navigate('Login')}>
